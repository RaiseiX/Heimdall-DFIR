...
router.delete('/:id', authenticate, async (req, res) => {
  try {
    ...
    const result = await withCaseDeletion(pool, caseId, client => client.query(
    ...
    await auditLog(req.user.id, 'delete_timeline_bookmark', 'case', caseId, { bookmark_id: id }, req.ip);
