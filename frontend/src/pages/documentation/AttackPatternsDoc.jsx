  ...
  return (
    <div style={{ border: `1px solid ${sev.border}`, borderRadius: 8, overflow: 'hidden', marginBottom: 10 }}>
      <button onClick={() => setOpen(o => !o)} className="w-full text-left"
        ...
        <p style={{ fontSize: 11, marginTop: 5, color: T.muted, fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', lineHeight: 1.5 }}>{pattern.summary}</p>
      </button>
      ...
      {open && (
        <div style={{ background: T.bg, padding: '14px 16px' }}>
            ...
            {pattern.apt && pattern.apt.length > 0 && (
              <div style={{ flex: 1, minWidth: 190 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 5 }}>
                  ...
                  <span style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-danger)', }}>Groupes APT</span>
                </div>
            ...
            {pattern.malware && pattern.malware.length > 0 && (
              <div style={{ flex: 1, minWidth: 190 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 5 }}>
                  ...
                  <span style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-warn)', }}>Malware / Outils</span>
                </div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Artefacts à rechercher</div>
          ...
          {pattern.commands && pattern.commands.length > 0 && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Commandes malveillantes connues</div>
          ...
          {pattern.sigma && pattern.sigma.length > 0 && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Règles Sigma</div>
          ...
          {pattern.iocs && pattern.iocs.length > 0 && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Indicateurs de Compromission (IOCs)</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          {pattern.remediation && pattern.remediation.length > 0 && (
            <div>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Remédiation & Détection</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
