        ...
        <div style={{ background: 'var(--fl-bg)', padding: '14px 16px', borderTop: '1px solid var(--fl-border)' }}>
          {topic.content.map((section, si) => (
            <div key={si} style={{ marginBottom: 14 }}>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>{section.label}</div>
          ...
          {topic.iocs && topic.iocs.length > 0 && (
            <div>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>IOCs réseau</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
