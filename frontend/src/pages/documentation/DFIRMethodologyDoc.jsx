...
function ChecklistSection({ title, items, color }) {
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 10, fontWeight: 700, color: c, marginBottom: 8 }}>{title}</div>
            ...
            if (s.type === 'commands') {
              return (
                <div key={i} style={{ marginBottom: 16 }}>
                  <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 10, fontWeight: 700, color: phase.badgeColor, marginBottom: 8 }}>{s.label}</div>
...
export default function DFIRMethodologyDoc({ search }) {
  ...
  return (
    <div style={{ padding: '26px 34px', maxWidth: 960 }}>
      ...
      {!search && (
        <div style={{ marginBottom: 22 }}>
          <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 10, fontWeight: 700, color: T.dim, marginBottom: 10 }}>Matrice de Sévérité & Escalade</div>
