      ...
      {open && (
        <div style={{ background: 'var(--fl-bg)', padding: '14px 16px', borderTop: '1px solid var(--fl-border)' }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Localisation</div>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Valeur Forensique</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          {artifact.commands && artifact.commands.length > 0 && (
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Commandes d'Investigation</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <div>
            <div style={{ fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontSize: 9, fontWeight: 700, color: 'var(--fl-accent)', marginBottom: 7 }}>Indicateurs Suspects</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
