  ...
  return (
    ...
    onMouseLeave={e => { e.currentTarget.style.borderColor = C.border; }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <span style={{ fontSize: 10, fontFamily: MONO, color: C.muted }}>{label}</span>
        <span style={{ flex: 1 }} />
        {(up || down) && (
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 8, paddingTop: 8, borderTop: `1px solid ${C.border2}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span style={{ fontSize: 10.5, fontFamily: MONO, color: C.muted }}>{t('dashboard.scan_coverage')}</span>
        ...
        <div style={{ minWidth: 0 }}>
          ...
          <div style={{ marginTop: 12, display: 'flex', gap: 14, alignItems: 'center', flexWrap: 'wrap', fontFamily: MONO, fontSize: 11, color: C.muted }}>
            ...
            {currentUser.role && (
              <>
                <Pip />
                <span style={{ }}>{currentUser.role}</span>
              </>
            )}
            <Pip />
          ...
          <DashCard
            ...
            badge={(
              <span style={{
                ...
                fontFamily: MONO, padding: '3px 8px', borderRadius: 4,
