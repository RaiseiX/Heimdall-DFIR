  ...
  return (
    <div style={{
      ...
      >
        ...
        {!collapsed && (
          <span style={{ marginLeft: 'auto', color: 'var(--fl-card)', fontSize: 8 }}>cliquer pour replier</span>
        )}
      </div>
    ...
    <div style={{
      ...
      {tab === 'chat' && (
        <>
          ...
          <div style={{ flexShrink: 0, padding: '8px 10px', borderTop: '1px solid var(--fl-bg)', background: 'var(--fl-bg)', display: 'flex', gap: 6, alignItems: 'flex-end' }}>
            {models.length > 0 && (
