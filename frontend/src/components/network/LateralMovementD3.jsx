    ...
    <div ref={containerRef} style={{ display: 'flex', flex: 1, width: '100%', height: '100%', position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: 'var(--fl-muted)', fontSize: 9, fontWeight: 600, marginBottom: 1 }}>Node risk</div>
          {[
          ...
          <div style={{ color: 'var(--fl-muted)', fontSize: 9, fontWeight: 600, marginBottom: 1 }}>Edges</div>
          {[
        ...
        {sortedNodes.slice(0, 3).filter(n => effectiveScore(n) >= 40).length > 0 && (
          <div style={{
            ...
            <div style={{ color: 'var(--fl-muted)', fontSize: 9, fontWeight: 600, marginBottom: 7 }}>Risky machines</div>
              ...
              <div style={{ flex: 1, overflowY: 'auto', padding: '10px 14px' }}>
                {selectedNode?.factors?.length > 0 && (
                  <div style={{ marginBottom: 12, padding: '8px 10px', borderRadius: 4, background: bgColor, border: `1px solid ${borderColor}` }}>
                    <div style={{ fontSize: 11, color: dimColor, marginBottom: 4, }}>
                      Pourquoi ce score
                    </div>
