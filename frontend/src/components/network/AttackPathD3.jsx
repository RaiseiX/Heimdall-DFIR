        ...
        >
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px 14px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontSize: 11 }}>
              {selectedNode.tactic && (
                <div>
                  <div style={{ color: dimColor, fontSize: 9, marginBottom: 3 }}>Tactique</div>
                  <span style={{
              ...
              <div>
                <div style={{ color: dimColor, fontSize: 9, marginBottom: 3 }}>Source</div>
              ...
              <div>
                <div style={{ color: dimColor, fontSize: 9, marginBottom: 3 }}>Confiance</div>
                <span style={{
              ...
              {selectedNode.timestamp && (
                <div>
                  <div style={{ color: dimColor, fontSize: 9, marginBottom: 3 }}>Horodatage</div>
              ...
              {selectedNode.notes && (
                <div>
                  <div style={{ color: dimColor, fontSize: 9, marginBottom: 3 }}>Notes</div>
              ...
              {selectedNode.artifact_ref && (
                <div>
                  <div style={{ color: 'var(--fl-muted)', fontSize: 9, marginBottom: 3 }}>Artefact source</div>
