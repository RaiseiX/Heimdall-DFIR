...
function FieldRow({ fk, fv }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: isBlock ? 'column' : 'row', gap: isBlock ? 4 : 10, padding: '8px 0', borderBottom: '1px solid var(--fl-border2)' }}>
      <div style={{ flexShrink: 0, width: isBlock ? 'auto' : 150, fontSize: 10, fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', color: 'var(--fl-muted)', paddingTop: 1 }}>
        {humanizeKey(fk, t)}
      </div>
      ...
      <div style={{ position: 'fixed', top: 0, right: 0, bottom: 0, zIndex: 1201, width: 'min(560px, 92vw)',
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '14px 16px', borderBottom: '1px solid var(--fl-border)' }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 9.5, fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', color: 'var(--fl-muted)', marginBottom: 5 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '6px 16px 16px' }}>
          ...
          {rawEntries.length > 0 && (
            <div style={{ marginTop: 16 }}>
              <div style={{ fontSize: 9.5, fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', color: 'var(--fl-muted)', margin: '0 0 4px' }}>
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          color: 'var(--fl-on-dark)', fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', fontWeight: 700, fontSize: 11, textAlign: 'left',
        }}
      >
          ...
          <div style={{ position: 'relative' }}>
            ...
            {showExc && (
              <div style={{ position: 'absolute', right: 0, top: '110%', zIndex: 50, width: 360, maxHeight: 320, overflowY: 'auto', background: 'var(--fl-panel)', border: '1px solid var(--fl-border)', borderRadius: 8, boxShadow: 'var(--fl-shadow-md)', padding: 8 }}>
                <div style={{ fontSize: 9.5, fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', color: 'var(--fl-muted)', padding: '4px 6px 8px' }}>{t('detections.exceptions.title')}</div>
                {exceptions.map(ex => (
