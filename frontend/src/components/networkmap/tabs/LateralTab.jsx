        ...
        return (
          <div key={i} style={{ padding: '5px 6px', marginBottom: 3, borderRadius: 2, background: '#0a0f18', borderLeft: `2px solid ${dir === 'out' ? 'var(--fl-warn)' : 'var(--fl-purple)'}` }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
              {eids.map(eid => (
                <span key={eid} style={{ fontSize: 6.5, padding: '1px 4px', borderRadius: 2, background: 'var(--fl-raised)', color: 'var(--fl-dim)', fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)' }}>
