      ...
      {events.map((ev, i) => {
        ...
        return (
          <div key={i} style={{ marginBottom: 2 }}>
            ...
            {isOpen && (
              <div style={{ background: 'var(--fl-bg)', border: '1px solid var(--fl-card)',
                borderTop: 'none', borderRadius: '0 0 3px 3px', padding: '8px 10px' }}>

                {ev.url && (
                  <div style={{ marginBottom: 6 }}>
                    <div style={{ fontSize: 7, color: 'var(--fl-subtle)', fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', marginBottom: 2 }}>URL</div>
                ...
                {ev.description && ev.description !== ev.url && (
                  <div>
                    <div style={{ fontSize: 7, color: 'var(--fl-subtle)', fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', marginBottom: 2 }}>
