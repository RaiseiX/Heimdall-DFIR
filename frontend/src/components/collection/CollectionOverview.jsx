        ...
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap', marginBottom: 24 }}>
            <div>
              ...
              <div style={{ fontFamily: MONO, fontSize: 10, color: 'var(--fl-muted)', marginTop: 3 }}>
          ...
          {breakdown.length > 0 && (
            <div style={{ marginBottom: 28 }}>
              <div style={{ fontFamily: MONO, fontSize: 10, color: 'var(--fl-muted)', fontWeight: 600, marginBottom: 12 }}>
