...
export default function ColumnManager({ allCols, hiddenCols, constantCols = [], onToggle, onReset, onClose }) {
  ...
  return (
    ...
    >
      <div style={{ padding: '2px 12px 6px', fontSize: 8, color: 'var(--fl-subtle)', fontWeight: 700,
      ...
      {dynamicCols.length > 0 && (
        <>
          <div style={{ padding: '6px 12px 3px', fontSize: 8, color: 'var(--fl-dim)', borderTop: '1px solid var(--fl-card)' }}>
            CSV Fields
          </div>
