...
const FAM_LABEL_STYLE = { fontSize: FS_TINY, fontFamily: MONO,
          ...
          {showSearches && (
            <div style={{ position: 'absolute', top: '100%', right: 0, zIndex: 500, marginTop: 4,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <span style={{ fontSize: 9, color: 'var(--fl-dim)',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4, borderTop: '1px solid var(--fl-card)', paddingTop: 8 }}>
                <span style={{ fontSize: 9, color: 'var(--fl-dim)', }}>{tr('timeline.my_searches')}</span>
              ...
              {shared.length > 0 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4, borderTop: '1px solid var(--fl-card)', paddingTop: 8 }}>
                  <span style={{ fontSize: 9, color: 'var(--fl-dim)', }}>{tr('timeline.shared_to_case')}</span>
                  {shared.map(s => (
            ...
            <div style={{ position: 'absolute', top: '100%', right: 0, zIndex: 500, marginTop: 4,
              ...
              {[
                ...
                <label key={f.field} style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  <span style={{ fontSize: 9, color: 'var(--fl-dim)', }}>{f.label}</span>
                  <input
                    value={f.val}
                    placeholder={f.hint}
                    list={f.list}
              ...
              <label style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <span style={{ fontSize: 9, color: 'var(--fl-dim)', minWidth: 80 }}>{tr('timeline.min_severity')}</span>
