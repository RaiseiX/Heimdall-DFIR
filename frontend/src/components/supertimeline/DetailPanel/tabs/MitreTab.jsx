    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: 8 }}>
      {r.mitre_technique_id && (
        <div style={{ borderRadius: 4, border: '1px solid color-mix(in srgb, var(--fl-accent) 25%, transparent)', overflow: 'hidden' }}>
          <div style={{ fontSize: 9, color: 'var(--fl-accent)', padding: '3px 7px', background: 'color-mix(in srgb, var(--fl-accent) 9%, transparent)', fontWeight: 600 }}>Technique ID</div>
      ...
      {r.mitre_technique_name && (
        <div style={{ borderRadius: 4, border: '1px solid color-mix(in srgb, var(--fl-accent) 25%, transparent)', overflow: 'hidden' }}>
          <div style={{ fontSize: 9, color: 'var(--fl-accent)', padding: '3px 7px', background: 'color-mix(in srgb, var(--fl-accent) 9%, transparent)', fontWeight: 600 }}>Technique</div>
          <div style={{ fontSize: 10, color: '#c0cfe0', padding: '5px 7px', background: 'var(--fl-panel)' }}>{r.mitre_technique_name}</div>
        </div>
      )}
      {r.mitre_tactic && (
        <div style={{ borderRadius: 4, border: '1px solid color-mix(in srgb, var(--fl-accent) 25%, transparent)', overflow: 'hidden' }}>
          <div style={{ fontSize: 9, color: 'var(--fl-accent)', padding: '3px 7px', background: 'color-mix(in srgb, var(--fl-accent) 9%, transparent)', fontWeight: 600 }}>Tactic</div>
