...
export const ARTIFACT_FIELD_PRIORITY = {
  ...
  amcache:   ['FullPath','Description','ApplicationName','SHA1','Size','ProductName'],
  amcache_files: ['FullPath','Name','SHA1','ProductName','Description','Size','LinkDate','BinaryType','IsOsComponent'],
  amcache_drivers: ['DriverName','DriverSigned','DriverInBox','DriverIsKernelMode','DriverCompany','DriverVersion','Service','DriverId','DriverLastWriteTime'],
  amcache_pnp: ['Description','Manufacturer','DriverName','HWID','Service','Class','Provider','InstallState'],
  amcache_programs: ['Name','Version','Publisher','InstallDate','Source','RootDirPath','UninstallString','ProgramId'],
  amcache_shortcuts: ['LnkName','KeyName','KeyLastWriteTimestamp'],
  amcache_device_containers: ['FriendlyName','Manufacturer','ModelName','IsConnected','IsNetworked','PrimaryCategory','DiscoveryMethod'],
  amcache_driver_packages: ['Inf','Provider','Class','Date','Version','Directory','Hwids','SubmissionId'],
  ...
  jumplist:  ['AppIdDescription','Path','LocalPath','EntryName','SourceFile'],
  jumplist_automatic: ['AppIdDescription','Path','CreationTime','LastModified','InteractionCount','PinStatus','Hostname','MacAddress','EntryNumber','MRU'],
  jumplist_custom: ['AppIdDescription','EntryName','LocalPath','TargetCreated','TargetModified','FileSize','WorkingDirectory','DriveType','VolumeLabel','VolumeSerialNumber'],
