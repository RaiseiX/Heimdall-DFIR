...
export default function YaraRulesPanel() {
  ...
  async function toggle(r) {
    try {
      await threatHuntingAPI.updateYaraRule(r.id, { is_active: !r.is_active });
      setToggleError('');
      load();
    } catch (e) {
      setToggleError(e.response?.data?.error || t('threat_hunt.errors.save_failed'));
    }
  }
    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          <Alert variant="danger" message={toggleError} />
