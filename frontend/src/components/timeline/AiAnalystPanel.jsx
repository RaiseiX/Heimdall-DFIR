    ...
    <div style={{
      ...
      <div
        ...
        style={{
          ...
          borderBottom: collapsed ? 'none' : '1px solid var(--fl-card)',
          userSelect: 'none',
        }}
      >
        ...
        {!collapsed && (
          <span style={{ marginLeft: 'auto', color: 'var(--fl-card)', fontSize: 8 }}>click to collapse</span>
        )}
      </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--fl-bg)' }}>
      ...
      <div style={{ flexShrink: 0, padding: '6px 12px', borderBottom: '1px solid var(--fl-bg)', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <select value={model} onChange={e => setModel(e.target.value)}
          style={{ background: 'var(--fl-panel)', border: '1px solid var(--fl-bg)', borderRadius: 4, color: 'var(--fl-dim)', fontSize: 9, fontFamily: 'var(--f-mono, "JetBrains Mono", monospace)', padding: '1px 4px' }}>
