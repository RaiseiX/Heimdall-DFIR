...
export default function CatScaleTimelineTab({ caseId, onTotalChange }) {
  ...
  return (
    <div style={{ fontFamily: 'monospace' }}>
      <div style={{
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
          ...
          <button
            ...
            style={{
              background: showHeatmap ? '#1c2333' : 'none',
              border: `1px solid ${showHeatmap ? '#4d82c0' : '#30363d'}`,
              borderRadius: 4, color: showHeatmap ? '#4d82c0' : '#7d8590',
              cursor: 'pointer', padding: '2px 8px', fontSize: 11,
              display: 'flex', alignItems: 'center', gap: 4,
            }}
          >
            <BarChart2 size={11} /> Heatmap
          </button>
      ...
      {showHeatmap && (
        <div style={{ background: '#161b22', border: '1px solid #30363d', borderRadius: 8, marginBottom: 12, overflow: 'hidden' }}>
